...
import { BellRing, CalendarCheck2, LayoutGrid, Wrench } from "lucide-react";
      ...
      <section className={`relative overflow-hidden rounded-[2rem] border border-white/20 p-8 text-white shadow-xl ${accent.accentClassName}`}>
        ...
        <div className="relative z-10">
          ...
          <p className="mt-3 text-sm font-medium text-white/90 drop-shadow-sm max-w-lg leading-relaxed">
            Manage your bookings, track maintenance requests, and stay updated across your campus operations from one central hub.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-5 md:grid-cols-3">
        ...
        >
          ...
          <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400">
            Browse available assets and check facility availability.
          </p>
        </article>
        ...
        >
          ...
          <h3 className="text-lg font-extrabold text-slate-900 dark:text-slate-100">Booking Management</h3>
          <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400">
            Request, track, and manage your facility bookings effortlessly.
          </p>
        </article>
        ...
        >
          ...
          <h3 className="text-lg font-extrabold text-slate-900 dark:text-slate-100">Incident Ticketing</h3>
          <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400">
            Report maintenance issues and monitor resolution progress.
          </p>
        </article>
      </section>
